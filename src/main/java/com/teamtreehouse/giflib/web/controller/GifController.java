...
public class GifController {
    ...
    public String addGif(Gif gif, @RequestParam MultipartFile file, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage("GIF Uploaded!", FlashMessage.Status.SUCCESS));
    ...
    public String formNewGif(Model model) {
        ...
        model.addAttribute("heading", "Upload New");
    ...
    public String formEditGif(@PathVariable Long gifId, Model model) {
        ...
        model.addAttribute("heading", "Update Existing");
        return "gif/form";
    }
    ...
    public String toggleFavorite(@PathVariable Long gifId, RedirectAttributes redirectAttributes, HttpServletRequest request) {
        ...
        redirectAttributes.addFlashAttribute("flash", new FlashMessage(gif.isFavorite() ? "Gif Favorited!" : "Gif Un-Favorited!", FlashMessage.Status.SUCCESS));
